...
class Saver():
    def __init__(self, config):
        self.display_dir = os.path.join(config['display_dir'], config['name'])
        self.model_dir = os.path.join(config['result_dir'], config['name'])
        self.image_dir = os.path.join(self.model_dir, 'images')
        self.display_freq = config['display_freq']
        self.img_save_freq = config['img_save_freq']
